	                                	...
	                                	<div class="searchbos">
	                                		<form id="form" name="form" method ="post">
	                      						<div style="padding-left:15px; width:100%; float: left;">
	                      							...
	                      							<div>
														<input class="form-control" style="width: 12%; float: left;" type="date" id="customerConsolidationContractDateStart" name="customerConsolidationContractDateStart" max="9999-12-31">
														<span style="float: left; padding-left: 10px; padding-right: 10px; padding-top: 5px;"> ~ </span>
														<input class="form-control" style="width: 12%; float: left;" type="date" id="customerConsolidationContractDateEnd" name="customerConsolidationContractDateEnd" max="9999-12-31">
													</div>
