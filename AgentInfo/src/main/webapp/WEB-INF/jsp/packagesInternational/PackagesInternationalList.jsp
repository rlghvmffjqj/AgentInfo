                                  ...
                                  <td>
                                    <div class="work-toolbar">
                                      ...
                                      <div class="toolbar-group">
                                        ...
                                        <sec:authorize access="hasRole('ADMIN')">
                                          <button class="btn2 btn-move myBtn" id="BtnDomestic" onclick="btnDomestic()">🚚 국내 이동</button>
                                        </sec:authorize>
                                      </div>
                                      ...
                                      <div class="toolbar-group">
                                        ...
                                        <button class="btn2 btn-light2 myBtn" onclick="selectColumns('#list', 'packagesInternationalList')">⚙ 컬럼 선택</button>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
