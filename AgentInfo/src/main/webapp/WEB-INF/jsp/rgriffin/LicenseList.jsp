                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                      <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">rGRIFFIN 라이선스 발급</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                                  ...
                                  <td>
                                    <div class="work-toolbar">
                                      ...
                                      <div class="toolbar-group">
                                        ...
                                        <button class="btn2 btn-light2 myBtn" id="BtnDownload">⬇ 다운로드</button>
                                      </div>
                                      ...
                                      <div class="toolbar-group">
                                        ...
                                        <button class="btn2 btn-light2 myBtn" id="BtnExcelExport" onclick="doExportExec()" title="현재 테이블 조회된 데이터를 Excel로 Export합니다.">📤 Excel 내보내기</button>
                                      </div>
                                      ...
                                      <div class="toolbar-group">
                                        ...
                                        <button class="btn2 btn-light2 myBtn" onclick="selectColumns('#list', 'rgriffinList')">⚙ 컬럼 선택</button>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
      ...
      if (chkList.length === 0) {
        ...
        $.ajax({
          ...
          success: function (result) {
            if (result === "FALSE") {
              Swal.fire("에러!", "JSON 파일이 존재하지 않습니다.", "error");
            } else {
