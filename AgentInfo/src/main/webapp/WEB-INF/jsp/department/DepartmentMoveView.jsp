...
<div class="modelHead">
	<div class="modelHeadFont">부서 선택</div>
</div>
...
<script>
	...
	function select() {
		...
		var departmentFullPath = node.data.key; // 선택 부서 풀 경로
		var departmentName = node.data.title; // 선택 부서
		$.ajax({
		    url: "<c:url value='/employee/departmentMove'/>",
		    type: "POST",
			data: {
					chkList : chkList,
