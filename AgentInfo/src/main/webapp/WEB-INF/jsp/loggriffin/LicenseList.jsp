															    ...
															    <td>
															        ...
															        <div class="work-toolbar">
															            ...
															            <div class="toolbar-group">
															                ...
															                <button class="btn2 btn-download myBtn" id="BtnDownload" title="선택한 테이블 행의 YML 파일을 다운로드합니다.">⬇ 다운로드</button>
															                <button class="btn2 btn-upload myBtn" id="BtnImport" title="YML 파일을 첨부하여 데이터를 추가합니다.">⬆ YML Import</button>
															            ...
															            <div class="toolbar-group">
															                ...
															                <button class="btn2 btn-setting myBtn" id="BtnRoute" title="라이선스 발급 설정 경로를 지정합니다.">⚙ 경로설정</button>
															                <button class="btn2 btn-setting myBtn" id="BtnMailSetting" title="라이선스 만료 메일발송 관련 설정을 등록합니다.">📧 메일설정</button>
															            </div>
