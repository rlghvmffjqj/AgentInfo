	...
	<body>
		...
		<div style="background: #FFFFFF;">
		    <div>
			    ...
			    <c:forEach var="list" items="${functionTestSettingList}">
					<div class="searchbos">
				    	<div class="functionTestSetting">
							<div style="margin-bottom: 5px;">
								<span style="float:left; margint-right:3px;"><%= num %>.</span><div style='text-align:left; float:left'><input class="form-control" type="text" style='width:400px'  value="${list.functionTestSettingFormName} > ${list.functionTestSettingCategoryName} > ${list.functionTestSettingSubCategoryName}"></div>
							</div>
					   		<table style="width:100%">
					   			<tbody>
					   				<tr>
					   					<td class="alignCenter">대항목</td>
					   					<td><input class="form-control" type="text" id="functionTestSettingFormName" name="functionTestSettingFormName" value="${list.functionTestSettingFormName}"></td>
