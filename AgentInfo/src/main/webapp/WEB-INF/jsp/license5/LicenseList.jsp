                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                      <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">라이선스 발급</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                                  ...
                                  <td>
                                    <div class="work-toolbar">
                                      ...
                                      <div class="toolbar-group">
                                        ...
                                        <button class="btn2 btn-light2 myBtn" id="BtnReIssue">🔄 재발급</button>
                                      </div>
                                      ...
                                      <div class="toolbar-group">
                                        ...
                                        <button class="btn2 btn-light2 myBtn" id="BtnDownload" title="선택한 테이블 행의 XML 파일을 다운로드합니다.">⬇ 라이선스 다운로드</button>
                                        <button class="btn2 btn-light2 myBtn" id="BtnImport" title="XML 파일을 첨부하여 데이터를 추가합니다.">⬆ XML Import</button>
                                      ...
                                      <div class="toolbar-group">
                                        ...
                                        <button class="btn2 btn-light2 myBtn" id="BtnMailSetting">📧 메일발송설정</button>
                                      </div>
                                      ...
                                      <div class="toolbar-group">
                                        ...
                                        <button class="btn2 btn-light2 myBtn" id="BtnIssueNote">📋 발급 이력</button>
                                        <button class="btn2 btn-light2 myBtn" id="BtnManagerChange">👤 담당자 변경</button>
      ...
      if (chkList.length === 0) {
        ...
        $.ajax({
          ...
          success: function (result) {
            if (result === "Empty") {
              Swal.fire("에러!", "XML 파일이 존재하지 않거나, <br>존재하지 않는 리스트가 포함되어 있습니다.", "error");
