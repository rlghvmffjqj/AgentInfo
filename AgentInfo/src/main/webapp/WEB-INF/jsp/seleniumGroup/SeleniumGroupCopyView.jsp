...
<div class="modelHead">
	<div class="modelHeadFont">그룹 선택</div>
</div>
...
<script>
	...
	function select() {
		...
		var seleniumGroupFullPath = node.data.key; // 선택 그룹 풀 경로
		var seleniumGroupName = node.data.title; // 선택 그룹
		$.ajax({
		    url: "<c:url value='/selenium/seleniumGroupCopy'/>",
		    type: "POST",
			data: {
					chkList : chkList,
