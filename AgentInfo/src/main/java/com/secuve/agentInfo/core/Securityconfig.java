...
public class Securityconfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			...
			.antMatchers("/packages/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA","LICENSE")
			.antMatchers("/customer/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA")
			.antMatchers("/product/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA")
			.antMatchers("/index").hasAnyRole("MEMBER","ADMIN","ENGINEER","QA","LICENSE")
			...
			.antMatchers("/requests/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA","LICENSE")
			.antMatchers("/requestsWrite/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA","LICENSE")
			...
			.antMatchers("/individualNote/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA","LICENSE")
			.antMatchers("/individualNoteTree/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA","LICENSE")
			.antMatchers("/sharedNote/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA","LICENSE")
			.antMatchers("/sharedNoteTree/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA","LICENSE")
			.antMatchers("/calendar/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA","LICENSE")
			.antMatchers("/sharedCalendar/**").hasAnyRole("ADMIN","MEMBER","ENGINEER","QA","LICENSE")
			...
			.antMatchers("/").hasAnyRole("MEMBER","ADMIN","ENGINEER","QA","LICENSE");
