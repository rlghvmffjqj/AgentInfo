...
@ToString
@Component
public class PackagesInternational {
	private int packagesInternationalKeyNum;					// Key Number
	private int packagesInternationalKeyNumOrigin;			// 정렬을 위한 키 값
	...
	private String packagesInternationalRegistrant;			// 데이터 추가 사용자
	private String packagesInternationalRegistrationDate;	// 데이터 추가 날짜
	private String packagesInternationalModifier;			// 데이터 수정 사용자
	private String packagesInternationalModifiedDate;		// 데이터 수정 날짜
	
	private String excelImportYear;				// 엑셀 Import 년도
	
	private int page=1;							// 기본 페이지 번호
	private int rows=25;						// 데이터 보여줄 갯수
	private String sidx="packagesInternationalKeyNumOrigin";		// 정렬할 기준 데이터
