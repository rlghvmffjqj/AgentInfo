		                                	...
		                                	<div class="searchbos">
		                                		<form id="form" name="form" method ="post">
													...
													<div class="col-lg-2">
		                      							...
		                      							<input type="date" id="serverListUidLogPeriodUse" name="serverListUidLogPeriodUse" class="form-control" max="9999-12-31">
		                      						</div>
		                      						<div class="col-lg-2">
		                      						...
		                      						<div class="col-lg-2">
		                      							...
		                      							<input type="date" id="serverListUidLogLastModifiedDate" name="serverListUidLogLastModifiedDate" class="form-control" max="9999-12-31">
		                      						</div>
		                      						<div class="col-lg-2">
