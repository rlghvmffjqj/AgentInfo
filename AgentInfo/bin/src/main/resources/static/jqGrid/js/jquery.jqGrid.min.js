...
f=document.createElement("div");f.className="ui-jqdialog-titlebar "+s.header,f.id=i.modalhead,w(f).append("<span class='ui-jqdialog-title'>"+"컬럼선택"+"</span>");var
